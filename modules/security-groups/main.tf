...
resource "aws_security_group" "app" {
  ...
  description = "Allow app port from web tier, SSH from bastion"
  vpc_id      = var.vpc_id
...
resource "aws_security_group" "efs" {
  ...
  description = "Allow NFS from app and web tiers"
  vpc_id      = var.vpc_id
  ...
  tags = { Name = "${var.project_name}-${var.environment}-sg-efs" }
}